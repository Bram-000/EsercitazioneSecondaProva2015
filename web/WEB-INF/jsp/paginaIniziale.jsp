                ...
                <div class="row">
                    <div class="input-field col l4 s12">
                        <select multiple>
                            ...
                            <option value="1">2015-12-12</option>
                            <option value="2">2016-01-01</option>
                            <option value="3">2016-03-13</option>
                        </select>
                    ...
                    <div class="input-field col l4 s12">
                        <select multiple>
                            ...
                            <option value="2">Venezia</option>
                            <option value="3">Milano</option>
                        </select>
                        <label>Scegli il luogo</label>
                    </div>

                    <button class="waves-effect waves-light btn-large blue col l4 s12">Tutti gli eventi</button>
                </div>
                    
                <ul class="collection with-header">
                    <li class="collection-header"><h5>Eventi (con filtro)</h5></li>
